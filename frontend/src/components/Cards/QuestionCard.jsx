...
import { LuSparkles, LuPinOff, LuPin, LuChevronDown } from "react-icons/lu";
...
const QuestionCard = ({
  ...
  return (
    <>
      <div className="bg-white rounded-lg mb-4 overflow-hidden py-4 px-5 shadow-xl shadow-gray-100/70 border border-gray-100/60 grow">
        <div className="flex items-start justify-between cursor-pointer">
          <div className="flex items-start gap-3.5">
            ...
            <h3
              className="text-xs md:text-[14px] font-medium text-gray-800 mr-0 mf:mr-20"
