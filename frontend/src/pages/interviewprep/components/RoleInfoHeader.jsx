...
const RoleInfoHeader = ({
  ...
  return (
    <div className="bg-white relative mt-6">
      <div className="container mx-auto px-10 md:px-0">
        ...
        <div className="w-[40vw] md:w-[30vw] h-[200px] flex items-center justify-center bg-white overflow-hidden absolute top-0 right-0">
          ...
          <div className="w-16 h-16 bg-teal-400 blur-[65px] animate-blob1"></div>
          <div className="w-16 h-16 bg-cyan-400 blur-[65px] animate-blob1"></div>
