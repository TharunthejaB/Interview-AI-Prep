export const BASE_URL = "https://interview-ai-prep-x89i.onrender.com"; // Change this to your backend URL
export const API_PATHS = {
    AUTH: {
        REGISTER: "/api/auth/register", // Signup
        LOGIN: "/api/auth/login", // Authenticate user & return JWT token
        GET_PROFILE: "/api/auth/profile", // Get logged-in user details
        UPDATE_PROFILE: "/api/auth/profile-update", // Get logged-in user details
    },
    IMAGE: {
    ...
    ΑΙ: {
        ...
        GENERATE_MORE: "/api/ai/generate-more-questions", // Generate concept explanation using Gemini
    },
    SESSION: {
